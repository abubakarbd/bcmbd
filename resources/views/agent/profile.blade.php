    ...
    <section class="content">
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          ...
          <form action="{{ route('Agent.profile.update') }}" method="POST">
            @csrf
              <div class="form-group">
                ...
                <input type="text" name="company" class="form-control @error('company') is-invalid @enderror" id="company" placeholder="Enter Client Name" value="{{ Auth::user()->company }}">
                @error('company')
              ...
              <div class="form-group">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter Client Name" value="{{ Auth::user()->name }}">
                @error('name')
                    <span class="text-danger mt-1" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group">
                ...
                <input type="text" name="mobile" class="form-control @error('mobile') is-invalid @enderror" id="mobile" value="{{ Auth::user()->mobile }}">
                @error('mobile')
                    <span class="text-danger mt-1" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
               ...
               <div class="box-footer pr-2">
                <button type="submit" class="btn btn-info pull-right">Profile Update</button>
              </div>
          </form>
        </div>
          </div>
          ...
          @endif
          <form action="{{ route('Agent.password') }}" method="POST">
            @csrf
            <div class="col-md-12">
              <div class="form-group">
