...
$agent = Auth::user()->id;
$month=date("m");
$clienta=DB::table('clients')->where('agent', $agent)->where('status', 1)->get();
$clientia=DB::table('clients')->where('agent', $agent)->where('status', 0)->get();
