      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ request()->is('admin/app') ? 'active' : '' }}">
          <a href="{{ route('app.index') }}">
            <i class="fa fa-dashboard"></i> App
          </a>
        </li>

        <li class="{{ request()->is('admin/agent/*') ? 'active' : ''}} treeview">
          <a href="">
          ...
          <ul class="treeview-menu">
            <li class="{{ request()->is('admin/agent/create') ? 'active' : '' }}"><a href="{{ route('agent.Form.create') }}"><i class="fa fa-fw fa-user-plus"></i> Add Home</a></li>

            <li class="{{ request()->is('admin/agent/list','agent/user/edit/*','agent/user/view/*') ? 'active' : '' }}"><a href="{{ route('agent.index') }}"><i class="fa fa-users"></i> Home List</a></li>
          </ul>
        </li>
         ...
         <li class="{{ request()->is('admin/agent/*') ? 'active' : ''}} treeview">
          ...
          <ul class="treeview-menu">
            <li class="{{ request()->is('admin/agent/create') ? 'active' : '' }}"><a href="{{ route('agent.Form.create') }}"><i class="fa fa-fw fa-user-plus"></i>Add Agent</a></li>

            <li class="{{ request()->is('admin/agent/list','agent/user/edit/*','agent/user/view/*') ? 'active' : '' }}"><a href="{{ route('agent.index') }}"><i class="fa fa-users"></i> Agent List</a></li>
            
            <li class="{{ request()->is('admin/agent/pakage/list','admin/agent/pakage/edit/*') ? 'active' : '' }}"><a href="{{ route('agent.pakage.index') }}"><i class="fa fa-users"></i> Pakage List</a></li>
          </ul>
        </li>

        <li class="{{ request()->is('admin/agent/*') ? 'active' : ''}} treeview">
          <a href="">
            <i class="fa fa-users"></i> <span>SE</span>
             <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="{{ request()->is('admin/agent/create') ? 'active' : '' }}"><a href="{{ route('agent.Form.create') }}"><i class="fa fa-fw fa-user-plus"></i> Add SE</a></li>

            <li class="{{ request()->is('admin/agent/list','agent/user/edit/*','agent/user/view/*') ? 'active' : '' }}"><a href="{{ route('agent.index') }}"><i class="fa fa-users"></i> SE List</a></li>
          </ul>
        </li>


        <li class="{{ request()->is('agent/bill/*') ? 'active' : '' }} treeview">
          <a href="">
            <i class="fa fa-fw fa-bar-chart"></i> <span>Agent Bill</span>
             <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="{{ request()->is('agent/bill/create') ? 'active' : '' }}"><a href=""><i class="fa fa-fw fa-money"></i>Agent Bill</a></li>
            <li class="{{ request()->is('agent/bill/month/list','agent/bill/month/list/*') ? 'active' : '' }}"><a href=""><i class="fa fa-fw fa-calendar-check-o"></i> Monthly Report </a></li>
            <li><a href=""><i class="fa fa-fw fa-calendar-check-o"></i> Yearly Report </a></li>
          </ul>
        </li>
