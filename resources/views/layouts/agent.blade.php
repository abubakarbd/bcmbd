    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ request()->is('agent/dashboard') ? 'active' : '' }}">
         ...
         <li class="{{ request()->is('agent/user/*') ? 'active' : ''}} treeview">
          <a href="">
          ...
          <ul class="treeview-menu">
            @if($linemane <= $ci)
            <li class="{{ request()->is('agent/user/list','agent/user/edit/*','agent/user/view/*') ? 'active' : '' }}"><a href="{{ route('user.index') }}"><i class="fa fa-users"></i> User List</a></li>
            @else
            <li class="{{ request()->is('agent/user/create') ? 'active' : '' }}"><a href="{{ route('userForm.create') }}"><i class="fa fa-fw fa-user-plus"></i>Add User</a></li>
            <li class="{{ request()->is('agent/user/list','agent/user/edit/*','agent/user/view/*') ? 'active' : '' }}"><a href="{{ route('user.index') }}"><i class="fa fa-users"></i> User List</a></li>
          @endif
          </ul>
        </li>

        <li class="{{ request()->is('agent/mane/*') ? 'active' : '' }} treeview">
          <a href="">
            <i class="fa fa-users"></i> <span>Billar Man</span>
             <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="{{ request()->is('agent/mane/create') ? 'active' : '' }}"><a href="{{ route('mane.create') }}"><i class="fa fa-fw fa-user-plus"></i>Add Billar Man</a></li>
            <li class="{{ request()->is('agent/mane/list') ? 'active' : '' }}"><a href="{{ route('linemane.index') }}"><i class="fa fa-users"></i> Billar Man List</a></li>
          </ul>
        </li>
        ...
        <li class="{{ request()->is('agent/bill/*') ? 'active' : '' }} treeview">
          ...
          <ul class="treeview-menu">
            <li class="{{ request()->is('agent/bill/shit') ? 'active' : '' }}"><a href="{{ route('bill.shit') }}"><i class="fa fa-fw fa-bar-chart"></i>Bill Shit</a></li>

            <li class="{{ request()->is('agent/bill/month/list','agent/bill/month/list/*') ? 'active' : '' }}"><a href="{{ route('bill.month.index') }}"><i class="fa fa-fw fa-calendar-check-o"></i> Monthly Report </a></li>
          </ul>
        </li>
